          ...
          <AnimatePresence mode="popLayout">
            {displayedStudies.map((study, idx) => (
              <motion.div
                ...
                className="group relative rounded-3xl overflow-hidden bg-[#0A0810] border border-white/5 hover:border-[#8B3DFF]/50 transition-colors duration-500 hover:shadow-[0_20px_50px_-15px_rgba(139,61,255,0.35)] cursor-pointer flex flex-col"
              >
