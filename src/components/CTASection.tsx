  ...
  return (
    <section id="cta-banner" className="relative py-24 lg:py-36 overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] h-[550px] bg-[#8B3DFF]/20 rounded-full blur-[180px] pointer-events-none" 
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div 
          ...
          className="relative rounded-3xl overflow-hidden glass-panel-glow border border-[#8B3DFF]/35 p-8 sm:p-14 lg:p-20 text-center shadow-[0_25px_70px_-15px_rgba(75,20,127,0.5)]"
        >
          ...
          <motion.div 
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-radial from-[#B15CFF]/20 via-[#4B147F]/10 to-transparent blur-[60px] pointer-events-none" 
          />
          ...
          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
            ...
            <motion.div 
              ...
              className="inline-block px-3.5 py-1.5 rounded-full border border-[#8B3DFF]/30 bg-[#8B3DFF]/10 text-[#B15CFF] text-[10px] uppercase tracking-[0.2em] font-bold mb-6"
            >
            ...
            <motion.h2 
              ...
              className="font-['Space_Grotesk'] text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.08] mb-6"
            >
              Ready to Build <br />
            ...
            <motion.p 
              ...
              className="text-[#A7A3B1] text-base sm:text-lg leading-relaxed mb-10 max-w-2xl"
            >
            ...
            >
              <motion.button
                ...
                className="w-full sm:w-auto group relative inline-flex items-center justify-center gap-2.5 px-9 py-4 rounded-full text-sm font-semibold tracking-wide text-white bg-[#8B3DFF] hover:bg-[#9B4DFF] shadow-[0_0_35px_rgba(139,61,255,0.5)] hover:shadow-[0_0_50px_rgba(177,92,255,0.8)] border border-[#B15CFF]/50 transition-all duration-300 cursor-pointer"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.04 }}
                whileTap={{ scale: 0.96 }}
                className="w-full sm:w-auto group inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-full text-sm font-semibold tracking-wide text-white bg-[#25D366]/20 hover:bg-[#25D366]/30 border border-[#25D366]/50 transition-all duration-300 shadow-[0_0_25px_rgba(37,211,102,0.2)] cursor-pointer"
              >
            ...
            <motion.div 
              ...
              className="flex flex-wrap items-center justify-center gap-6 text-xs text-[#85818E]"
            >
