  ...
  return (
    <section id="testimonials" className="relative py-12 sm:py-16 lg:py-20 overflow-hidden bg-[#050508]">
      ...
      <motion.div 
        ...
        className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-[#8B3DFF]/10 rounded-full blur-[140px] pointer-events-none" 
      />
      <motion.div 
        animate={{ scale: [1, 1.15, 1], opacity: [0.03, 0.08, 0.03] }}
        transition={{ duration: 9, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        className="absolute bottom-10 right-10 w-[400px] h-[400px] bg-emerald-500/5 rounded-full blur-[130px] pointer-events-none" 
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div 
          ...
          className="flex flex-col items-center text-center max-w-2xl mx-auto mb-8 sm:mb-10"
        >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3 mb-8">
          {[
            ...
            <motion.div
              ...
              className="rounded-xl bg-[#0A0810]/90 border border-white/5 px-3.5 py-3 sm:py-3.5 flex flex-col justify-between text-center relative overflow-hidden group hover:border-[#8B3DFF]/40 transition-colors shadow-sm"
            >
        ...
        <motion.div layout className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
          <AnimatePresence mode="popLayout">
            {displayedTestimonials.map((testimonial) => (
              <motion.div
                ...
                className="group relative rounded-2xl bg-[#0A0810]/80 backdrop-blur-xl border border-white/5 hover:border-[#8B3DFF]/40 p-4 sm:p-5 flex flex-col justify-between transition-colors duration-300 hover:shadow-[0_12px_30px_-8px_rgba(139,61,255,0.2)]"
              >
                <div>
        ...
        {filteredTestimonials.length > 4 && (
          <div className="mt-8 flex justify-center">
            <motion.button
              ...
              className="px-6 py-2.5 rounded-full bg-[#120B20] hover:bg-[#1A1030] border border-[#8B3DFF]/40 hover:border-[#8B3DFF]/70 text-[#D7BFFF] hover:text-white text-xs uppercase tracking-widest font-bold flex items-center gap-2 transition-colors shadow-[0_0_15px_rgba(139,61,255,0.2)] cursor-pointer"
            >
