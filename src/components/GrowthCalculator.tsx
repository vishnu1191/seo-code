  ...
  return (
    <section id="calculator" className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-1/2 left-1/3 w-[650px] h-[450px] bg-[#8B3DFF]/15 rounded-full blur-[170px] pointer-events-none" 
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="rounded-3xl bg-[#0A0810]/80 backdrop-blur-2xl border border-white/5 p-6 sm:p-10 shadow-[0_20px_60px_-15px_rgba(75,20,127,0.35)] hover:border-[#8B3DFF]/30 transition-colors duration-500"
        >
            ...
            <div className="lg:col-span-6 p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-[#140E23] to-[#07070B] border border-white/10 shadow-inner flex flex-col justify-between">
              ...
              <div>
                ...
                <div className="mb-6">
                  ...
                  <motion.div 
                    key={annualIncrementalRevenue}
                    initial={{ scale: 0.97, opacity: 0.8 }}
                    animate={{ scale: 1, opacity: 1 }}
                    transition={{ duration: 0.3 }}
                    className="font-['Space_Grotesk'] text-3xl sm:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-[#D7BFFF] to-[#8B3DFF]"
                  >
